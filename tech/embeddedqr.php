...
<body>
    <form action="embeddedqr.php" method="post" enctype="multipart/form-data">
        <h2>Embedded QR</h2>
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(isset($_FILES["photo"]) && $_FILES["photo"]["error"] == 0){
        ...
        //send API
//        $url = "http://hash-1987.azurewebsites.net/api/visual_qr";
...
//        echo $base64; 
        ...
        if(in_array($filetype, $allowed)){
            ...
            if(file_exists("/Visual_QR/upload/" . $filename)){
                echo $filename . " is already exists.";
            } else{
                move_uploaded_file($_FILES["photo"]["tmp_name"], "/Visual_QR/upload/" . $filename);
