...
function startGame() {
    myGamePiece = new component(30, 30, "red", 410, 490);
...
<br>
<div>
<p>manual control for extra fun!</p>
...
Blue speed: <input class = "edit-items" type = "number" name="lname" id="bspeed" value= -14 max="120" min = "-120" ><br><br>
Red mass: <input name="lname" id="mass1" value =4>
Blue mass: <input name="lname" id="mass2" value= 3><br><br>
