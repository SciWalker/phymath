...
<head><meta http-equiv="Content-Type" content="text/html; charset=windows-1252">
  <!-- Title -->
  <title>Simulation - Genetic Algorithm</title>
  <!-- Meta -->
  
  <meta name="description" content="simulation, genetic algorithm">
    ...
    <div id="content" class="container">
      <div class="row margin-vert-30">
        <!-- Side Column -->
          ...
          <div class="col-md-9">
            <!-- Main Content -->
<?php include("/home/sciwalker/public_html/Simulations/genetic algo.html") ?>
